...
const InvoiceViewer = ({ toggleInvoiceEditor }) => {
  ...
  useEffect(() => {
    ...
    url.get("purchase-quotation/" + id).then(({ data }) => {
      ...
      pushArr.push([null, 1, 2, 8, 5]);
      setaddress({
        ...address,
        street: data[0]?.party?.street,
        city: data[0]?.party?.city,
        po_no: data[0]?.party?.post_box_no,
      });
      ...
      let decimal = parseFloat(
        parseFloat(data[0].net_amount).toFixed(2).split(".")[1]
      );
      ...
      <ul>
        ...
        <li>Bank details – The payment will be dealt either through transfer or letter of credit. In case of transfer, AMACO will bear transfer charges for the first transfer. If the transfer is not through due to reasons beyond AMACO’s responsibility, supplier will have to bear all the charges.<br>&nbsp;</li>
        <li><strong>Delivery period &amp; penalty – Should supplier fail to deliver or perform the work according to the agreed date (s) and/or schedule set out in the PO, AMACO may in its sole discretion, with or without prior notice to the supplier:</strong>
          <ul>
            <li><strong>Extend the time by means of change order.</strong></li>
            <li><strong>Cancel the PO or part of the work and procure goods or services of similar description from other works.</strong></li>
            <li><strong>Claim from supplier the damages suffered (including the amount by which the cost of replacements exceeds the Price) and to the extend allowed under in lieuof the agreed liquidated damages provided for above.</strong><br>&nbsp;</li>
          </ul>
        </li>
        <li>Order progress – Order progress reports must be sent on weekly basis, without any reminders.<br>&nbsp;</li>
        ...
        <li>Quality &amp; Warranty - The work shall conform in all respects to the quality requirements and specifications set out in the PO; and if not specified, to the normal and customary specifications or quality of such goods, or in the case of services; in accordance with accepted industry practices and any applicable professional standards and codes.<br><br>
          <ul>
            ...
            <li>If any such defects or failure is discovered or occur within the warranty period, AMACO shall notify supplier accordingly, and supplier shall promptly, and at his sole cost and risk repair or replace or replace or otherwise makegood any and all work which are found to be defective. In addition, supplier shall compensate AMACO for all costs and expenses reasonably incurred or suffered in connection with the defect and the repairs or replacement of the works (or part thereof) under the warranty.</li>
            <li>The repairs/replacement works will carry the same warranty as from the date of replacement.</li>
            <li>This warranty is additional to and without prejudice to any further or specific terms of warranties offered by supplier or applicable in respect of the work.<br>&nbsp;</li>
          </ul>
        </li>
        <li><strong>Compliance to Laws and Ethics </strong>- In the performance of any purchase agreement, supplier shall take all reasonable steps to ensure full compliance with all laws and regulations of the KSA as well as any other applicable laws or international obligations</li>
      </ul>`);
      ...
      if (data[0].currency_type == "SAR") {
        if (data[0].net_amount) {
          setress(
            words1?.split(",").join(" ") +
              " Riyals " +
              (parseFloat(data[0]?.net_amount?.split(".")[1]) !== NaN
                ? parseFloat(data[0]?.net_amount?.split(".")[1]) == 0.0
                  ? "."
                  : decimal
  ...
  const deletepo = () => {
    Swal.fire({
      ...
      if (result.value) {
        url.delete(`purchase-quotation/${id}`).then((res) => {
        ...
        Swal.fire("Cancelled", "Your Purchase Order is safe :)", "error");
      }
    });
  };
                ...
                <td>
                  ...
                  >
                    <Grid container spacing={3} className="p-4">
                      ...
                      >
                        <span style={{ fontWeight: 1000 }}>VENDOR NUMBER</span>
                        <br></br>
                        {party_code}
                      </Grid>
                      <Grid className="pl-0 pb-4" xs={4}>
                        <span style={{ fontWeight: 1000 }}>PURCHASE ORDER</span>
                        <br></br>
                        {po_number}
                      </Grid>
                      <Grid className="pl-2 pb-4 pr-0 mr-1" align="right" xs>
                        <span style={{ fontWeight: 1000 }}>ORDER DATE</span>
                        <br></br>
                    ...
                    <Grid container spacing={3} className="p-4">
                      ...
                      >
                        <div className="pl-2 pb-4" style={{ width: 250 }}>
                          ...
                          <span style={{ fontWeight: 1000 }}>VENDOR NAME</span>
                          <br></br>
                          {company}
                        </div>
                      </Grid>
                      ...
                      <Grid className="pl-2 pb-4 pr-0 mr-1" align="right" xs>
                        <span style={{ fontWeight: 1000 }}>INCO TERMS</span>
                        <br></br>
                        {inco_terms}
                      </Grid>
                    </Grid>
                  ...
                  >
                    <Grid container spacing={3} className="p-4">
                      ...
                      >
                        ...
                        {payment_terms} */}
                        <span style={{ fontWeight: 1000 }}>VENDOR ADDRESS</span>
                        <br></br>
                        {[
                          vendorAddress?.building_no,
                          vendorAddress?.street,
                          vendorAddress?.city,
                          vendorAddress?.zip_code,
                      ...
                      <Grid className="pl-2 pb-4" xs={2}>
                        ...
                        {inco_terms} */}
                        <span style={{ fontWeight: 1000 }}>PAYMENT TERMS</span>
                        <br></br>
                        {payment_terms}
                      </Grid>
                  ...
                  >
                    <div style={{zIndex:'1000'}} className="viewer__order-info px-2 mb-2 flex justify-between">
                      <Table>
                        <TableHead
                          style={{
                    ...
                    <div className="viewer__order-info px-2 mb-2 flex justify-between" style={{pageBreakInside: "avoid"}}> 
                    <Table style={{position:'relative',top:'-57px'}}>
                    <TableHead
                          style={{
                            // backgroundColor: "#1d2257",
                            // display: "table-row-group",
                          ...
                          <TableRow style={{ border: "1px solid #ccc" }}>
                            ...
                            >
                              <div>
                                ...
                                <div style={{ float: "right" }}>
                                  {parseFloat(freight_charges).toLocaleString(
                                    undefined,
                                    { minimumFractionDigits: 2 }
                                  )}
                                </div>
                      ...
                      <div className="px-4 flex justify-between">
                                <div className="flex">
                                  <div
                                    ...
                                    style={{ wordBreak: "break-word" ,marginTop:'10px',width:'568px'}}
                                  >
                                    <strong>TOTAL IN WORDS</strong>
                                    <br></br>
                                    <b>{currency_type}</b> {ress}
                    ...
                    <p
                      ...
                      className="pl-6 text-error"
                    >
                      NOTE
                    </p>
                    : Please refer annexure for terms & condition
                    <div id="annexure"></div>
