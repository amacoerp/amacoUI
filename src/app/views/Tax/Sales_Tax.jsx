  ...
  useEffect(() => {
    ...
    url.get('salesTax').then(({data})=>{
      console.log(data)
        ...
        settotal(sumTotal)
        var sumVat=data.reduce((initial,cal)=> initial= initial+ parseFloat(cal.vat_in_value),0)
        setvattotal(sumVat)
        var subTotal=data.reduce((initial,cal)=> initial= initial+ parseFloat(cal.total_value),0)
                          ...
                          map((item, index) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                >
                                  {
                                     parseFloat(item.total_value).toLocaleString(undefined,{
                                ...
                                >
                                  {parseFloat(item.vat_in_value).toLocaleString(undefined,{
                                    minimumFractionDigits:2
                                  })}
