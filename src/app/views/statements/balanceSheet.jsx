              ...
              <TableBody>
                  ...
                  <TableRow >
                    ...
                    <TableCell className="px-4 capitalize" style={{fontSize: 12}} align="right">
                      ...
                      {(output_vat-input_vat-taxpaid_vat).toLocaleString(undefined,{minimumFractionDigits:2})}
                    </TableCell>
                  </TableRow>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell
                    ...
                    align="right"
                  >
                  {((AccountPayable)+(output_vat-input_vat-taxpaid_vat)).toLocaleString(undefined,{minimumFractionDigits:2})}
              ...
              <TableBody>
                {/* {RE.map((RE, index) => ( */}
                  <TableRow >
                    ...
                    <TableCell className="px-4 capitalize"style={{fontSize: 12}} align="right">
                    {(caluclateTotal(salesExpense,"SALES")-caluclateTotalExpense(arrExpense,"Operational Expenses","Governmental Expenses","Marketing Expenses","PURCHASE")).toLocaleString(undefined,{
                      minimumFractionDigits:2
         ...
         <Table>
          <TableHead>
            <TableRow>
              ...
              {(((AccountPayable)+(output_vat-input_vat-taxpaid_vat))+(caluclateTotal(salesExpense,"SALES")-caluclateTotalExpense(arrExpense,"Operational Expenses","Governmental Expenses","Marketing Expenses","PURCHASE"))).toLocaleString(undefined,{
                      minimumFractionDigits:2
