...
const BalanceSheet = ({ refval }) => {
  ...
  const [AccountPayable, setAccountPayable] = useState(0.00)
  const [output_vat, setoutput_vat] = useState(0.00)
  const [input_vat, setinput_vat] = useState(0.00)
  const [taxpaid_vat, settaxpaid_vat] = useState(0.00)
  const [asset, setasset] = useState(0.00)
  const [bank_expense, setbank_expense] = useState(0.00)
  const [cash_expense, setcash_expense] = useState(0.00)
  const [bank_receipt, setbank_receipt] = useState(0.00)
  const [cash_receipt, setcash_receipt] = useState(0.00)
  const [receivable_amount, setreceivable_amount] = useState(0.00)
  ...
  const caluclateTotalExpense = (arr, c1, c2, c3, c4) => {
    const res = arr.filter(obj => (obj.CATEGORY == c1 || obj.CATEGORY == c2 || obj.CATEGORY == c3 || obj.CATEGORY == c4)).reduce((a, v) => a = a + parseFloat(v.AMOUNT), 0.00)


    return res
  }
  const caluclateTotal = (arr, category) => {
    const res = arr.filter(obj => (obj.CATEGORY == category)).reduce((a, v) => a = a + parseFloat(v.AMOUNT), 0.00)
            ...
            <table >
              ...
              <div>
                <Table style={{ align: 'right' }}>
                  <TableHead>
                    <TableRow >
                      <TableCell className="pl-6" colSpan={12} style={{ fontSize: 20, align: 'right', marginLeft: 0 }}>
                        <span >
                          BALANCE SHEET
                        </span>
                      </TableCell>
                      <TableCell style={{ fontSize: 20, align: 'right' }} className="pl-10" colSpan={3} >
            ...
            <TableCell className="px-2" style={{ fontSize: 20 }} colspan={4}>
                ...
                <div className="flex justify-around">
                  <div>
                    ...
                    <TableHead>
                      <TableRow>
                        <TableCell className="pl-6" style={{ fontSize: 20, marginLeft: 200 }} colspan={4}>
                          Liabilities & Equities
                        </TableCell>
                        {/* <TableCell className="px-2" style={{ fontSize: 20 }} colspan={4}>
                Assets
            ...
            <TableCell className="px-0" >Current Liabilities</TableCell>
                      ...
                      <TableBody>
                        ...
                        <TableRow >
                          <TableCell
                            className="pl-6"
                            style={{ color: "#4791db", fontSize: 12, cursor: 'pointer' }}
                            align="left"

                          >
                            <span onClick={() => {
                              setShouldOpenEditorDialog(true); setstate('pay');
                            }} >Acc. Payable Control(IP 1)-8024000</span>
                          </TableCell>
                    ...
                    <TableCell className="px-4 capitalize" style={{fontSize: 12}} align="right">
                      {Cl.AMM}
                        ...
                        <TableRow >
                          ...
                          >
                            <span onClick={() => {
                              setShouldOpenEditorDialog(true); setstate('vat');
                            }} >Output VAT -9016000</span>
                          </TableCell>
                          <TableCell className="px-4 capitalize" style={{ fontSize: 12 }} align="right">

                            {isNaN((output_vat - input_vat - taxpaid_vat)) ? '0.00' : (output_vat - input_vat - taxpaid_vat).toLocaleString(undefined, { minimumFractionDigits: 2 })}
                          </TableCell>
                        </TableRow>
                      ...
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell
                            ...
                            align="right"
                          >
                            {isNaN((AccountPayable) + (output_vat - input_vat - taxpaid_vat)) ? '0.00' : ((AccountPayable) + (output_vat - input_vat - taxpaid_vat)).toLocaleString(undefined, { minimumFractionDigits: 2 })}
                        ...
                        <TableRow >
                          ...
                          >
                            <span onClick={() => {
                              setShouldOpenEditorDialog(true);
                              setstate('profit')
                            }} > Profit From Jan 01,2021 To Dec 31,2021</span>
                          </TableCell>
                          <TableCell className="px-4 capitalize" style={{ fontSize: 12 }} align="right">
                            {isNaN((caluclateTotal(salesExpense, "SALES") - caluclateTotalExpense(arrExpense, "Operational Expenses", "Governmental Expenses", "Marketing Expenses", "PURCHASE"))) ? '0.00' : (caluclateTotal(salesExpense, "SALES") - caluclateTotalExpense(arrExpense, "Operational Expenses", "Governmental Expenses", "Marketing Expenses", "PURCHASE")).toLocaleString(undefined, {
                              minimumFractionDigits: 2
                      ...
                      <TableBody>
                        ...
                        <TableRow >
                          ...
                          <TableCell className="px-4 capitalize" align="right" style={{ fontWeight: 600 }}>
                            {isNaN((caluclateTotal(salesExpense, "SALES") - caluclateTotalExpense(arrExpense, "Operational Expenses", "Governmental Expenses", "Marketing Expenses", "PURCHASE"))) ? '0.00' : (caluclateTotal(salesExpense, "SALES") - caluclateTotalExpense(arrExpense, "Operational Expenses", "Governmental Expenses", "Marketing Expenses", "PURCHASE")).toLocaleString(undefined, {
                              minimumFractionDigits: 2
                  ...
                  <div className="py-0 text-center">
                    ...
                    <Table style={{ float: "right" }}>
                      ...
                      <TableHead>
                        <TableRow>
                          <TableCell className="px-4" style={{ fontSize: 16 }}>Fixed Assets</TableCell>
                        </TableRow>
                      </TableHead>
                      <TableBody>
                        ...
                        <TableRow >
                          ...
                          <TableCell style={{ fontSize: 12, paddingRight: 20 }} align="right">
                            {(asset).toLocaleString(undefined, { minimumFractionDigits: 2 })}
                          </TableCell>
                        </TableRow>
                        {/* ))} */}
                      </TableBody>
                    ...
                    <TableCell style={{fontSize: 12,paddingRight:20}} align="right">
                      ...
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell
                            style={{ color: "black", fontSize: 12, fontWeight: 600, paddingRight: 20 }}
                            align="right"
                          >
                            {(asset).toLocaleString(undefined, { minimumFractionDigits: 2 })}
                      ...
                      <TableHead>
                        <TableRow>
                          <TableCell className="px-4" style={{ fontSize: 16 }}>Current Assets</TableCell>
                          {/* <TableCell className="px-0">Action</TableCell> */}
                        </TableRow>
                      </TableHead>
                      <TableBody>
                    ...
                    <TableCell style={{fontSize: 12,paddingRight:20}} align="right">
                      {asset.toLocaleString(undefined,{
                        ...
                        <TableRow >
                          ...
                          <TableCell style={{ fontSize: 12, paddingRight: 20 }} align="right">
                            {Advance.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                          </TableCell>
                        </TableRow>
                        <TableRow >
                          <TableCell
                        ...
                        <TableRow >
                          ...
                          <TableCell style={{ fontSize: 12, paddingRight: 20 }} align="right">
                            {receivable_amount.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                          </TableCell>
                        </TableRow>
                        <TableRow >
                          {/* <TableCell
                      ...
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell
                            ...
                            align="right"
                          >
                            {(receivable_amount + Advance + (bank_receipt - bank_expense) + (cash_receipt - cash_expense)).toLocaleString(undefined, {
                              minimumFractionDigits: 2
                            })}
                          </TableCell>
                        </TableRow>
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      <TableCell style={{ fontSize: 14, fontWeight: 600 }} className="pl-6" colspan={2}>
                        Total Liabilies & Equities
                      </TableCell>
                      <TableCell className="pr-3" style={{ fontSize: 16, fontWeight: 600, float: "right" }} >
                        {isNaN((((AccountPayable) + (output_vat - input_vat - taxpaid_vat)) + (caluclateTotal(salesExpense, "SALES") - caluclateTotalExpense(arrExpense, "Operational Expenses", "Governmental Expenses", "Marketing Expenses", "PURCHASE")))) ? '0.00' : (((AccountPayable) + (output_vat - input_vat - taxpaid_vat)) + (caluclateTotal(salesExpense, "SALES") - caluclateTotalExpense(arrExpense, "Operational Expenses", "Governmental Expenses", "Marketing Expenses", "PURCHASE"))).toLocaleString(undefined, {
                          minimumFractionDigits: 2

                        })}
                      </TableCell>
                      <TableCell className="pl-3" style={{ fontSize: 14, fontWeight: 600 }} colspan={2} >
                        Total Assets
                      </TableCell>
                      <TableCell className="pl-50" style={{ fontSize: 16, fontWeight: 600, paddingRight: 20 }} align="right" >
                        {(receivable_amount + Advance + (bank_receipt - bank_expense) + (cash_receipt - cash_expense) + asset).toLocaleString(undefined, { minimumFractionDigits: 2 })}
                      </TableCell>
                    </TableRow>
                  </TableHead>
                </Table>
