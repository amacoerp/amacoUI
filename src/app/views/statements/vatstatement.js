...
const VatStatement = ({
  ...
  const [debit_balance, setdebit_balance] = useState(0.00);
  const [credit_balance, setcredit_balance] = useState(0.00);
  ...
  const filter_data=(id,fDate,tDate)=>{
    ...
    let cSum=0.00;
    let vSum=0.00;
    response_data.filter(obj=>(moment(obj.created_at).format('YYYY-MM-DD')<moment(date2).format('YYYY-MM-DD'))).map((item, i) => {
   ...
   result.map((item,id)=>{
    ...
    console.log((dSum-cSum-vSum)+debitSum-creditSum-vatSum)
                  ...
                  <div>
                    <div className="px-4 mb-2 pl-4 pt-4 flex ">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                             {(payment_account_id=="All"||!payment_account_id)?"All":cname}
                          </TableCell>
                            ...
                            return (
                              ...
                              >
                                ...
                                >
                                  ...
                                  {item.credit === null
                                    ? ""
                                    : parseFloat(item.credit).toLocaleString(undefined,{
                                      minimumFractionDigits:2
                                    })}
                                </TableCell>
                                <TableCell
                                ...
                                >
                                  ...
                                  {item.debit === null ? "" : parseFloat(item.debit).toLocaleString(undefined,{
                                    minimumFractionDigits:2
                                  })}
                    ...
                    {/* Calculate the opening balance If the amount is credit */}
                          ...
                          >
                            ...
                            >
                              {/* Total Debit balance */}
                              {parseFloat(debit_balance).toLocaleString(undefined,{minimumFractionDigits:2})}
                            </TableCell>
                            <TableCell
                              className="pl-0 capitalize"
                              align="right"
                            ...
                            >
                             ...
                             {parseFloat(credit_balance).toLocaleString(undefined,{minimumFractionDigits:2})}
                            </TableCell>
                            <TableCell
                              className="pl-0 capitalize"
                              style={{
