...
const MemberEditorDialog = ({ uid, open, handleClose, userid, getSalary, data }) => {
    ...
    const submitHandle = () => {
        ...
        url.post(`update-emp`, formData).then(({ data }) => {
            console.log(data)
            Swal.fire({
                title: 'Success',
                type: 'success',
    ...
    return (
        ...
        >
            ...
            <Card className="p-6" elevation={3}>
                ...
                <center><h4>Employee Details
                    {
                        proEditable == true ? <Icon editable={proEditable}
                            onClick={submitHandle} style={{ float: "right" }}>check_circle</Icon> : <Icon editable={proEditable}
                                onClick={makeEditableHandle} style={{ float: "right" }}>edit</Icon>
                    }
                ...
                <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                    ...
                    <Grid style={{ padding: "10px" }} item xs={2} sm={4} md={4}>
                        <center><h5>Personal Details</h5></center>
                        <Divider />
                        <Table className="mb-4">
                            {proEditable == true ? <TableBody>
                                <TableRow>
                                ...
                                <TableRow>
                                    <TableCell className="pl-4">Designation</TableCell>
                                    <TableCell className="">{empList[0]?.designation}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell className="pl-4">Contact Number</TableCell>
                                    <TableCell className="">{empList[0]?.contact_number}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell className="pl-4">Email-ID</TableCell>
                                ...
                                <TableRow>
                                    <TableCell className="pl-4">Present Address</TableCell>
                                    <TableCell className="">{empList[0]?.present_address}</TableCell>
                                </TableRow>
                            </TableBody>}
                        </Table>
                    </Grid>
                    <Grid style={{ padding: "10px" }} item xs={2} sm={4} md={4}>
                        <center><h5>Other Details</h5></center>
                        <Divider />
                        <Table className="mb-4">
                            {
                                proEditable == true ? <TableBody>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell><TextField type="file" name="file" onChange={(e) => handleChangeImage(e)} /></TableCell>
                                    </TableRow>
                                </TableBody> : <TableBody>
                                    <TableRow>
                                        <TableCell className="pl-4">Passport Number</TableCell>
                                    ...
                                    <TableRow>
                                        <TableCell className="pl-4">Passport Expire Date</TableCell>
                                        <TableCell>{moment(empList[0]?.passport_exp_date).format('DD MMM YYYY')}</TableCell>
                                    </TableRow>
                                    <TableRow>
                                        <TableCell className="pl-4">IQAMA Expire Data</TableCell>
                                        <TableCell>{moment(empList[0]?.iqama_exp_date).format('DD MMM YYYY')}</TableCell>
                                    </TableRow>
                                    <TableRow>
                                        <TableCell className="pl-4">Date of Join</TableCell>
                                        <TableCell>{moment(empList[0]?.date_of_join).format('DD MMM YYYY')}</TableCell>
                                    </TableRow>
                                    <TableRow>
                                        <TableCell className="pl-4">Job Agreement</TableCell>
                                        <TableCell><a href={empList[0]?.file}>Download</a></TableCell>
                                    </TableRow>
                                </TableBody>
                            }
                        </Table>
                    ...
                    <Grid style={{ padding: "10px" }} item xs={2} sm={4} md={4}>
                        <center><h5>Salary Details</h5></center>
                        <Divider />
                        <Table className="mb-4">
                            {proEditable == true ? <TableBody>
                                <TableRow>
                                ...
                                <TableRow>
                                    <TableCell style={{ width: "250px" }} className="pl-4">Home Rent Allowance (HRA)</TableCell>
                                    <TableCell><TextField
                                        style={{ position: "relative", top: "13px" }}
                                ...
                                <TableRow>
                                    <TableCell className="pl-4">Travel Allowance (TA)</TableCell>
                                    <TableCell><TextField
                                        style={{ position: "relative", top: "13px" }}
