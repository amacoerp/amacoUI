...
const SalesRInvoiceViewer = ({ toggleInvoiceEditor }) => {
       ...
       C.R No 205500334 | VAT 810398615200003
        ...
        />
                                ...
                                <td>
                                    <div className="viewer__order-info px-4 mb-4 pt-5 flex justify-between">
                                        <div className="ml-2">
                                            ...
                                            <h3 style={{ fontSize: 20 }}><strong>SALES RETURN</strong></h3>
              ...
              {po_number} */}
                                                    ...
                                                    <div className="pl-2 pb-4">
                                                        <span style={{ fontWeight: 1000 }}>SUPPLIER VAT NUMBER</span><br></br>
                                                        {party[0]?.vat_no}
              ...
              {moment(rdate).format('DD MMM YYYY')} */}
                                                        <span style={{ fontWeight: 1000 }}>CREDITNOTE NUMBER</span><br></br>
                                                        {party[0]?.quotationr_no}
                                        ...
                                        <div className="px-2 flex justify-end">
                                            <div className="flex " >
                                                <div className="">
                                                    <div className="pl-2 pb-4">
                                                        <span style={{ fontWeight: 1000 }}>CREDITNOTE DATE</span><br></br>
              ...
              {moment(rdate).format('DD MMM YYYY')} */}
                                            ...
                                            <Table>
                                                <TableHead style={{ backgroundColor: '#1d2257', display: 'table-row-group' }}>
                                                    <TableRow>
                                                        ...
                                                        <TableCell className="px-0" style={{ border: "1px solid #ccc", fontFamily: "Calibri", color: "#fff", fontWeight: '1000', fontSize: 16 }} width="0px" align="center">QUOTATION NO</TableCell>
                ...
                SAR
                    ...
                    <FormattedNumber value={vat_in_value} currency={"SAR"} style="currency" />
                                                    ...
                                                    <TableRow style={{ border: "1px solid #ccc" }}>
                                                        <TableCell className="pl-0 capitalize" colspan={8} style={{ border: "1px solid #ccc", fontFamily: "Calibri", width: 200, fontSize: 16 }}>
...
export default SalesRInvoiceViewer;
